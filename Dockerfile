...
RUN         apt-get -y update && \
            apt-get -y install supervisor python php-common php-fpm php-zip php-sqlite3 wget curl php-curl php-cli php-mysql php-xml php-mbstring php-sabre-vobject&& \
            apt-get clean && \
